namespace ApisFideicomisos.Models
{
    ...
    public class TFimypeByIDResponse
    {
        public Int32 IdTabla { get; set; }
    ...
    public class FullFogacpResponse
    {
        public int IdTabla { get; set; }
        public string Sucursal { get; set; }
        public string Agencia { get; set; }
        public DateTime FechaSolicitud { get; set; }
        public string OfCredito { get; set; }
        ...
        public string MontoGarant { get; set; }
        public string NA { get; set; }
        public DateTime FechaRegistro { get; set; }
        public string Actividad { get; set; }
        public string DestinoFondos { get; set; }
        public decimal CoberturaSolicitada { get; set; }
        ...
        public string MaximoGarantias { get; set; }
